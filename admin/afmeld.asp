...
userinput=style & "<table width=400 border=1 cellspacing=0 cellpadding=5><tr><td><b>Afmelding</b></td><td><b>Eco-info</b></td></tr><tr><td>Navn</td><td>" & name & "</td></tr><tr><td>Fornavn</td><td>" & firstname & "&nbsp;</td></tr><tr><td>Efternavn</td><td>" & lastname & "&nbsp;</td></tr><tr><td>Årsag</td><td>" & why & "&nbsp;</td><tr><tr><td>Besked</td><td>" & request("besked") & "&nbsp;</td></tr><tr><td>I Insider</td><td><a href='http://insider.eco-info.dk/dgs/edit.asp?id=" & id & "'>Link</a>&nbsp;</td></tr></table>"
theBody="Hej Kirsten<br>En bruger ønsker at blive afmeldt på Øko-info " & Time() & "<br>Vil du rette ham/hende i Insider/Filemaker. Tak" & userinput
'response.write theBody
'response.end
SendCDOMail "kmh@eco-net.dk","web@eco-net.dk","AFMELDING PÅ ØKO-INFO",theBody
SendCDOMail "eco-net@eco-net.dk","web@eco-net.dk","AFMELDING PÅ ØKO-INFO",theBody
