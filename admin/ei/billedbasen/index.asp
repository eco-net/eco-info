...
rsPageData.Source = "SELECT *  FROM (image_cat_maindata c INNER JOIN images i ON c.id = i.cat_id)  WHERE 0=0  ORDER BY i.id desc;"
...
<!--del-->
<br>
<table width="" border="0" cellspacing="0" cellpadding="0" align="center" name="maintable" bgcolor="#FFFFFF" height="380">
  <tr>
    <td>
      <div align="center"><span class="sidebarHeaderBox"><span><span class="sidebarHeader">Se <b>B</b>illeder</span></span></span></div></td>
    <td><%=(rsPageData_first)%> - <%=(rsPageData_last)%> af <%=(rsPageData_total)%></td>
    <td>
      <div align="left"><A HREF="<%=MM_movePrev%>">tilbage</A> <A HREF="<%=MM_moveNext%>">n&aelig;ste</A> </div></td>
  </tr>
  <tr>
    <td valign="top" colspan="3">
		...
		j=1 %>
            ...
            <td width="75" height="100" valign="top">
              <table>
                <tr>
                  <td height="75" colspan="6" align="left" valign="top"> <% if rsPageData("thumbnail")>0 then %>
                    <img src="thumbnail/<%=(rsPageData.Fields.Item("filename").Value)%>" alt="<%=(rsPageData.Fields.Item("filename").Value)%>-<%=(rsPageData.Fields.Item("subtext").Value)%>-<%=(rsPageData.Fields.Item("source").Value)%>" >
                    <% else %>
					
                    <img src="upload/<%=(rsPageData.Fields.Item("filename").Value)%>" alt="<%=(rsPageData.Fields.Item("filename").Value)%>-<%=(rsPageData.Fields.Item("subtext").Value)%>-<%=(rsPageData.Fields.Item("source").Value)%>" width="75">
                    <% end if %></td>
                  <td align="left" valign="top"><p><span class="listheader"><strong>ID</strong> <%=(rsPageData.Fields.Item("id").Value)%></span></p>
                    <p><a href="delete.asp?id=<%=rsPageData.Fields.Item("id").Value%>">slet</a></p></td>
                </tr>
                <tr>
                  <td>str: </td>
                  <td class="listheader">
                    <% if rsPageData("twocol")>0 then  %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=2','','scrollbars=yes,resizable=yes,width=300,height=300')">2</a>
                    <% end if %></td>
                  <td class="listheader">
                    <% if rsPageData("threecol")>0 then %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=3','','scrollbars=yes,resizable=yes,width=300,height=300')">3</a>
                    <% end if %></td>
                  <td class="listheader">
                    <% if rsPageData("rightcol")>0 then %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=R','','scrollbars=yes,resizable=yes,width=300,height=300')">R</a>
                    <% end if %></td>
                  <td class="listheader">
                    <% if rsPageData("branding")>0 then %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=B','','scrollbars=yes,resizable=yes,width=300,height=300')">B</a>
                    <% end if %></td>
                  <td class="listheader">
                    <% if rsPageData("splash")>0 then %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=S','','scrollbars=yes,resizable=yes,width=300,height=300')">S</a>
                    <% end if %></td>
                  <td class="listheader">
                    <% if rsPageData("tema")>0 then %>
                    <a href="#" onClick="MM_openBrWindow('showimage.asp?id=<%=(rsPageData.Fields.Item("id").Value)%>&size=T','','scrollbars=yes,resizable=yes,width=300,height=300')">T</a>
                    <% end if %></td>
                </tr>
            </table></td>
            <% if j mod 5=0 then %>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <div align="left"><%=(rsPageData_first)%> - <%=(rsPageData_last)%> af <%=(rsPageData_total)%> <A HREF="<%=MM_movePrev%>">tilbage</A> <A HREF="<%=MM_moveNext%>">n&aelig;ste</A> </div></td>
        </tr>
    </table></td>
  </tr>
</table>
