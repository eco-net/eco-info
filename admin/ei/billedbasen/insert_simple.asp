...
Dim Repeat1__index
Repeat1__index = 0
rsSize_numRows = rsSize_numRows + Repeat1__numRows
%>
<html>
...
<div align="center"><span class="contentHeader1">Opret Nyt billede med tekst</span><br>
</div>
<form name="form1" method="post" action="upload_simple.asp" enctype="multipart/form-data">
...
<tr> 
<td class="sidebarHeaderBox" colspan="2"><span><span class="sidebarHeader">Inds&aelig;t 
Billede. </span></span></td>
</tr>
<tr> 
...
<p> 
<select name="size" class="formInputobject">
...
<p> Beskrivende billedtekst:<br>
<input type="text" name="subtext" class="formInputobject">
</p>
<p>Kilde:<br>
<input type="text" name="source" class="formInputobject">
</p>
</td>
<td align="center"> 
<p align="center">Hent billede:<br>
<input type="file" name="file" class="formInputobjectLong">
</p>
<p align="center"> 
<input type="submit" name="Submit" value="Inds&aelig;t" class="formSubmitbutton">
<br>
<br>
</p>
</td>
...
<div align="left"> <span class="listheader">Størrelser. </span></div>
</td>
</tr>
<tr> 
<td align="center" valign="top" bgcolor="#CCCCCC"> 
<div align="left"> 
<% 
While ((Repeat1__numRows <> 0) AND (NOT rsSize.EOF)) 
%>
<%=(rsSize.Fields.Item("name").Value)%> : <%=(rsSize.Fields.Item("sizeinfo").Value)%><br>
<% 
...
<tr> 
<td align="center" valign="top" bgcolor="#CCCCCC">
<div align="left" class="listheader">Procedure.</div>
</td>
</tr>
<tr>
<td align="center" valign="top" bgcolor="#CCCCCC">
<div align="left">Ved upload til databasen, gemmes en kopi af billedet p&aring; 
webhotellet, i mappen original, navngivet med id-nr.<br>
J&aelig;vnligt overf&oslash;res de originale til ecodev-serveren, og der laves 
thumbnails, som uploades til webhotellet.</div>
</td>
</tr>
</table>
</td>
