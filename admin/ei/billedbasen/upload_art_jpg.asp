...
<%
Dim w2col,w3col,wTema,wRightcol,wThumbnail,width,height,path,theID,filename,img_size
w2col=540
w3col=360
wTema=258
wRightcol=160
...
img_size = Upload.Form("img_size")
width = File.ImageWidth
height = File.ImageHeight
path=Server.MapPath("upload/") & "/" & filename
response.write "Der er oprettet dette billede i billedbasen: <br>"
Set Image = Server.CreateObject("AspImage.Image")
	...
	writeImgDB
	writeArtDB
	File.Delete  'slet den uploadede og kopier thumbnail til upload-mappen, for at undgå navnesammenfald og spare plads.
...
Function makeImage(theSize,sizeName)
	...
	Image.SaveImage
if not theSize=wThumbnail then
...
Function writeArtDB()
		...
		rs2.Open "eiart_r_img", MM_ecoinfo_STRING, 2, 3
		rs2.AddNew
		rs2("artid")=Upload.Form("artid")
		rs2("imgid")=theID
		rs2("imgsize")=Upload.Form("img_size")
		rs2.Update
		rs2.Close
end Function
