...
<tr>
<td class="sidebarHeaderBox"><span><span class="sidebarHeader">Send mails til email-lister</span></span></td>
<td class="sidebarHeaderBox"><div align="center"><strong>TEXT</strong></div></td>
<td class="sidebarHeaderBox"><div align="center"><strong>HTML</strong></div></td>
</tr>

<tr>
<td class="formLabeltext"> &nbsp;&nbsp;Send nyheds-mail til &Oslash;ko-info og 
Øko-net (fra Fmp)</td>
<td class="formLabeltext"><input type="button" value="Skriv ..." onClick="window.location='new.asp?mail=1';" class="formbutton" name="Button4"></td>
<td align="right">
<input type="button" value="Skriv ..." onClick="window.location='newHTML.asp?mail=1';" class="formbutton" name="Button"></td>
</tr>
<tr>
<td class="formLabeltext">&nbsp;&nbsp;Send mail til Insider-brugere</td>
<td class="formLabeltext"><input type="button" value="Skriv ..." onClick="window.location='new.asp?mail=2';" class="formbutton" name="Button22"></td>
<td align="right">
<input type="button" value="Skriv ..." onClick="window.location='newHTML.asp?mail=2';" class="formbutton" name="Button2"></td>
</tr>
<tr>
<td class="formLabeltext">&nbsp;&nbsp;Send mail til modtagere fra Filemaker</td>
<td class="formLabeltext"><input type="button" value="Skriv ..." onClick="window.location='new.asp?mail=3';" class="formbutton" name="Button32"></td>
<td align="right">
<input type="button" value="Skriv ..." onClick="window.location='newHTML.asp?mail=3';" class="formbutton" name="Button3"></td>
</tr>
</table>
</td>
</tr>
...
<p align="center"><a href="/admin/ei/mails/filemaker.asp" target="_blank"><strong>Inden afsendelse af Nyhedsmail</strong></a> </p>
<p align="center"><a href="/admin/ei/mails/returmail/retur.asp" class="formLabeltext">H&aring;ndtering af returmails</a> </p>
</form>
<!-- #EndEditable --> </td>
</tr>
<tr> 
