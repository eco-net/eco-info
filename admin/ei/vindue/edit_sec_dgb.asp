...
rssek.Source = "SELECT *  FROM eivindue_sektion  WHERE sek='dgb'  ORDER BY linie"
rssek.CursorType = 0
...
<tr> 
<td colspan="2" bgcolor="#CCCCCC"><span class="contentHeader2"><strong>Sektioner p&aring; Forside</strong></span></td>
</tr>
</table>
...
Det Gr&oslash;nne Bibliotek</span><span class="footer"> - &oslash;kologisk videns-samling 
</span><br>
<br>
...
<td> 
<input type="hidden" name="sek" value="dgb">
