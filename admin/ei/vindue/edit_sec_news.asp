...
rssek.Source = "SELECT *  FROM eivindue_sektion  WHERE sek='news'  ORDER BY linie"
rssek.CursorType = 0
...
<br>
<input type="button" name="Submit2322" value="V&aelig;lg link" onClick="window.open('/shared/sel_link.asp','thewin','width=300,height=300,top=200,left=300')" class="formbutton">
</p>
...
Aktuelt</span><span class="footer"> - Nyheder og andet aktualitetsstof</span><br>
<br>
...
<input type="hidden" name="sek" value="news">
