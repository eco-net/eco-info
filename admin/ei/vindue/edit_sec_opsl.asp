...
rssek.Source = "SELECT *  FROM eivindue_sektion  WHERE sek='opsl'  ORDER BY linie"
rssek.CursorType = 0
...
Opslagstavlen</span><span class="footer"> - fra bruger til bruger</span><br>
<br>
...
<td> 
<input type="hidden" name="sek" value="opsl">
