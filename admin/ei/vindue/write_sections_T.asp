...
okheader="<tr><td colspan='2'><span class='homeHeader'>&Oslash;ko-Kalenderen</span>" &_ 
		...
		"<a href=""/kurser/index.asp""><b>Kursuskalenderen1</b></a></td></tr>"
dgbheader="<tr><td colspan='2'><span class='homeHeader'>Det Gr&oslash;nne Bibliotek</span>" &_ 
		...
		"<table border='0' cellpadding='0' cellspacing='3' align='center' width='98%'>"&_
		"<tr><td><img src='/shared/graphics/layout/empty.gif'></td><td><img src=""/shared/graphics/layout/alertarrow.gif"" width=""14"" height=""8"">" &_
		"<a href=""/art/index.asp""><b>Artikler</b></a></td></tr>"
...
rs.Source = "SELECT *  FROM eivindue_sektion WHERE tema_id=" & tema_id & " AND sek='dgs' AND show=1 ORDER BY linie" 
getSek()
pagetext=pagetext & okheader
rs.Source = "SELECT *  FROM eivindue_sektion WHERE tema_id=" & tema_id & " AND sek='ok' AND show=1 ORDER BY linie" 
getSek()
pagetext=pagetext & dgbheader
rs.Source = "SELECT *  FROM eivindue_sektion WHERE tema_id=" & tema_id & " AND sek='dgb' AND show=1 ORDER BY linie" 
getSek()
pagetext=pagetext & opslheader
rs.Source = "SELECT *  FROM eivindue_sektion WHERE tema_id=" & tema_id & " AND sek='opsl' AND show=1 ORDER BY linie" 
getSek()
pagetext=pagetext & newsheader
rs.Source = "SELECT *  FROM eivindue_sektion WHERE tema_id=" & tema_id & " AND sek='news' AND show=1 ORDER BY linie" 
getSek()

pagetext=pagetext & "</table>" 
if choose = 0 then '**** temasektioner oprettes ****
filename="/log/ei/home/vindue/inc_sections_" & tema_id & ".txt"
...
listtext=""
rs.Source = "SELECT * FROM eivindue_sektion WHERE tema_mrk=1 AND tema_id=" & tema_id & " ORDER BY sek"
rs.Open()
while not rs.EOF
if rs("linktekst")<>"" then
