...
function submitSearch(theform) {
	if(theform.artcat.selectedIndex>0)theform.artcatname.value=stripit(theform.artcat.options[theform.artcat.selectedIndex].text);
	if(theform.artsbj.selectedIndex>0)theform.artsbjname.value=stripit(theform.artsbj.options[theform.artsbj.selectedIndex].text);
	return true
}
</script>
...
<tr bgcolor="#FAFAF4"> 
<td><img src="/shared/graphics/layout/header_arrows.gif" width="22" height="22"></td>
<td width="98%" class="sidebarHeader">&nbsp;&nbsp;VIS ARTIKLER</td>
</tr>
<tr> 
<td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
...
<script src="/log/optionfiles/artcat_options.js"></script>
</select>
<br>
