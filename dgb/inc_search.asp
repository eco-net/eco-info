...
function submitSearch(theform) {
	if(theform.dgbcat.selectedIndex>0)theform.dgbcatname.value=stripit(theform.dgbcat.options[theform.dgbcat.selectedIndex].text);
	if(theform.dgbsbj.selectedIndex>0)theform.dgbsbjname.value=stripit(theform.dgbsbj.options[theform.dgbsbj.selectedIndex].text);
	return true
}
</script>
