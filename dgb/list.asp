...
'IF LEN(rsPageData.Fields.Item("webaddress").value)>0 THEN response.write "<a href=""" & "http://" & rsPageData.Fields.Item("webaddress").value & """ target=""_blank"" title=""Åbner publikationen i et nyt vindue"">På nettet <img src=""/shared/graphics/layout/arrows_fwd.gif"" width=""10"" height=""7"" border=""0""></a><br>"
