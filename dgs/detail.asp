...
<br>
<a href="mailto:<%=(rsPageData.Fields.Item("emailaddress2").Value)%>" title="Åbner en ny mail i din mail-klient med denne adresse som modtager"><%=(rsPageData.Fields.Item("emailaddress2").Value)%></a> 
<%end if %>
<%end if %>
...
<br><a href="http://<%=(rsPageData.Fields.Item("www2").Value)%>" title="Åbner hjemmesiden i et nyt vindue" target="_blank"><%=rsPageData.Fields.Item("www2").Value%><img src="/shared/graphics/layout/arrows_fwd.gif" width="10" height="7" border="0"></a> 
<%end if%>
<%end if%>
</td>
</tr>
