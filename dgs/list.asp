...
rsPageData.Source = "SELECT m.id,m.zip,m.name,m.shortdescription,m.www,m.firstname,m.middlename,m.lastname,m.fullname,m.stopped,p.postnr,p.city  FROM (eiorg_maindata m LEFT JOIN eisys_postnr p ON m.zip_dk=p.postnr)  WHERE 0=0  ORDER BY p.postnr"
rsPageData.Source=replace(rsPageData.Source,"0=0",theWhere)
rsPageData.Source=replace(rsPageData.Source,"(eiorg_maindata m LEFT JOIN eisys_postnr p ON m.zip_dk=p.postnr)",theFrom)
rsPageData.Source=replace(rsPageData.Source,"ORDER BY p.postnr",theOrder)
...
response.write "<tr><td class='listheader'>" & rsPageData.Fields.Item("postnr").Value & " " & rsPageData.Fields.Item("city").Value & "</td></tr>"
...
response.write "<tr><td><img src=""/shared/graphics/spacer.gif"" width=""3"" height=""4""></td></tr>"
response.write "<tr><td><span class=""contentheader2""><a href='stopped_detail.asp?id=" & rsPageData("id") & "'  title=""" & replace(rsPageData.Fields.Item("shortdescription").Value,chr(13),"<br>") & """>"
IF LEN(rsPageData.Fields.Item("name").Value)>0 THEN
	response.write rsPageData.Fields.Item("name").Value
ELSE
	response.write rsPageData.Fields.Item("firstname").Value & "&nbsp;" & rsPageData.Fields.Item("lastname").Value
END IF
response.write "</a></span><br><font color='red'>Organisationen er ophørt</font></td></tr>"
response.write "<tr><td><img src=""/shared/graphics/spacer.gif"" width=""3"" height=""7""></td></tr>"
response.write "<tr><td background=""/shared/graphics/layout/dots_horz.gif"" height=""1""><img src=""/shared/graphics/spacer.gif"" width=""3"" height=""1""></td></tr>"
