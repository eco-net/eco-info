...
rsPageData.Source = "SELECT m.id,m.zip,m.name,m.shortdescription,m.www,m.firstname,m.middlename,m.lastname,m.fullname,m.stopped  FROM eiorg_maindata m  WHERE m.stopped=1  ORDER BY m.name"
...
<td> 
<div align="center">
<p align="left">Listen her er et arkiv over organisationer fra De Gr&oslash;nne 
Sider, som af forskellig &aring;rsag, ikke l&aelig;ngere eksisterer.<br>
I h&aring;b om at listen ikke bliver for lang, undlades s&oslash;gebaren.</p>
...
<br>
Listen kan udskrives med alle v&aelig;sentlige data:<br>
...
<td class="contentHeader1" colspan="2" width="98%">Fandt <%=rsPageData_total%> organisationer - der er oph&oslash;rt</td>
...
response.write "<tr><td><span class=""contentheader2""><a href=stopped_detail.asp?id=" & rsPageData.Fields.Item("id").Value & ">"
