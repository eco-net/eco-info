...
<td width="98%" class="sidebarHeader">&nbsp;&nbsp;STØT ØKO-NET !</td>
</tr>
<tr><td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td></tr>
<tr><td valign="top" colspan="2"> 
...
<a  style="cursor:pointer" onClick="javascript:open_ewire_email('eco-net@eco-net.dk','%D8ko-net+','St%F8ttebel%F8b','','50,00','24','1');"> &Oslash;ko-net beh&oslash;ver din/jeres hj&aelig;lp - '100 st&oslash;ttebel&oslash;b &aacute; mindst 50 kr. om &aring;ret' - det er mindste kravet i lovgivningen for at v&aelig;re godkendt som &sect;8A-organisation, der giver adgang til at s&oslash;ge st&oslash;tte hos Finanstyrelsens Tips- og Lottomidler. <br>
Bidragsyderen har fradragsret for de gavebel&oslash;b, der overstiger 500 kr., dog maksimalt 5.000 kr. om &aring;ret. <br>
Men selv et personligt st&oslash;ttebidrag &aacute; mindst 50 kr. har alts&aring; stor betydning og effekt! 
</a>
<br>
<br>
</td>
...
<!--#include file="kampagne_forside.asp"-->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr> 
<td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
