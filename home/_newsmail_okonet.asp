...
IF step=3 THEN
	...
	IF LEN(request("cmag"))>0 THEN theBody=theBody & "- Seneste nummer af Nyhedsbladet" & VbCrLf
...
&nbsp;&nbsp;&nbsp;
Modtage det seneste nummer af Nyhedsbladet &Oslash;ko-net.<br>
<br>
<input type="checkbox" name="cmember" value="1" <%IF LEN(request("cmember"))>0 THEN response.write "checked"%>>
&nbsp;&nbsp;&nbsp; Blive medlem af netv&aelig;rket (koster 200,- kr om &aring;ret).<br>
<br>
</td>
<td>&nbsp;</td>
</tr>
