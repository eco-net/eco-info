...
<table width="160" border="0" align="center">
  <tr>
    <td><p>Google S&oslash;gning p&aring; &Oslash;ko-nets sider </p>
<!-- SiteSearch Google -->
<form method="get" action="http://www.eco-info.dk/home/google.asp" target="_top">
<table border="0" bgcolor="#ffffff">
<tr><td height="32" nowrap="nowrap">
<input type="hidden" name="domains" value="www.eco-info.dk;www.eco-net.dk;www.bu.dk"></input>
...
<input type="submit" name="sa" value="Søg" id="sbb"></input>
</td></tr>
<tr>
<td nowrap="nowrap">
<table>
...
<span class="style1">
<span class="style2">
<label for="ss0" title="Søg på internettet"><font color="#000000">Web</font></label>
</span> </span></td>
<td>
<input type="radio" name="sitesearch" value="www.eco-info.dk" id="ss1"></input>
<span class="style2">
<label for="ss1" title="Søg www.eco-info.dk"><font color="#000000">www.eco-info.dk</font></label>
</span></td>
</tr>
<tr>
<td>
<input type="radio" name="sitesearch" value="www.eco-net.dk" id="ss2"></input>
<span class="style2">
<label for="ss2" title="Søg www.eco-net.dk"><font color="#000000">www.eco-net.dk</font></label>
</span></td>
<td>
<input type="radio" name="sitesearch" value="www.bu.dk" id="ss3"></input>
<span class="style2">
<label for="ss3" title="Søg www.bu.dk"><font color="#000000">www.bu.dk</font></label>
</span></td>
</tr>
</table>
<input type="hidden" name="client" value="pub-1814652264778642"></input>
<input type="hidden" name="forid" value="1"></input>
<input type="hidden" name="ie" value="ISO-8859-1"></input>
<input type="hidden" name="oe" value="ISO-8859-1"></input>
<input type="hidden" name="safe" value="active"></input>
<input type="hidden" name="flav" value="0000"></input>
<input type="hidden" name="sig" value="vfd-OkHjFrb_eilT"></input>
<input type="hidden" name="cof" value="GALT:#666666;GL:1;DIV:#CCCC98;VLC:666632;AH:center;BGC:FAFAF4;LBGC:FAFAF4;ALC:666632;LC:666632;T:666632;GFNT:666666;GIMP:666666;LH:50;LW:155;L:http://web.eco-net.dk/shared/graphics/ECO-NET-logo.gif;S:http://web.eco-net.dk/shared/graphics/ECO-NET-logo.gif;FORID:11"></input>
<input type="hidden" name="hl" value="da"></input></td></tr></table>
</form>
...
<script type="text/javascript">
   ...
   var googleSearchFrameWidth = 540;
