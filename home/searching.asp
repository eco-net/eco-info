...
<tr> 
<td colspan="2" class="contentHeader1" align="left"> S&oslash;getips</td>
</tr>
<tr> 
...
<tr>
<td valign="top"> 
<p class="contentHeader2">&Oslash;ko-info best&aring;r af omr&aring;derne / sektionerne: 
</p>
<p><span class="listheader">De Gr&oslash;nne Sider</span> - der rummer stamdataene 
for alle optagne personer eller orgaisationer i &Oslash;ko-info databasen<br>
<span class="listheader">&Oslash;ko-kalenderen</span> - der er en oversigt over 
de arrangementer som organisationer og personer i De Gr&oslash;nne Sider har arrangeret<br>
<span class="listheader">Det Gr&oslash;nne Bibliotek</span> - der er en oversigt 
over de publikationer eller medier som en person eller organisation i De Gr&oslash;nne 
Sider har udgivet<br>
<span class="listheader">Opslagstavlen</span> - er et &aring;bent sted for alle 
bruger af &Oslash;ko-info-portalen med mulighed for et direkte budskab til alle 
andre brugere<br>
<span class="listheader">Nyheder</span> - bringer sidst nyt fra det gr&oslash;nne 
omr&aring;de i noteform</p>
<p>&nbsp;</p>
</td>
</tr>
</table>
...
<tr> 
<td valign="top" class="contentHeader2">S&aring;dan s&oslash;ger du p&aring; &Oslash;ko-info 
</td>
</tr>
</table>
<br>
V&aelig;lg et af de fem sektioner p&aring; forsiden i menuen. For hvert omr&aring;de 
er der nu mulighed for at finde de nyeste poster i databasen eller at s&oslash;ge 
p&aring; &eacute;n af f&oslash;lgende fire m&aring;der, der ogs&aring; kan kombineres: 
<p><span class="listheader">S&oslash;g p&aring; kategorier: </span><br>
Kategorier er for hver omr&aring;de / sektion en overordnet type inddeling. S&oslash;ger 
man kun p&aring; en kategori, f&aring;r man alle posterne i kategorien for den 
valgte sektion</p>
<p><span class="listheader">S&oslash;g p&aring; emneord: </span><br>
Her findes de emneord som der bruges i databasen og der kan s&oslash;ge direkte 
efter alle poster i den valgte sektion indenfor et emneomr&aring;de.</p>
<p><span class="listheader">S&oslash;g geografisk:</span><br>
Som udgangspunkt s&oslash;ges der ved valg af kategori eller emneord i hele Danmark. 
Men med den geografiske s&oslash;gemulighed kan man afgr&aelig;nse sin s&oslash;gning 
til fx et amt eller en kommune.</p>
<p><span class="listheader">Fritekst s&oslash;gning:</span><br>
N&aring;r du s&oslash;ger fritekst s&oslash;gning p&aring; &Oslash;ko-info, b&oslash;r 
du altid bruge det kortest mulige s&oslash;geord. Vi underst&oslash;tter ingen 
avancerede syntakser, kun enkelte s&oslash;geord.</p>
<p></p>
<p><br>
</p>
</td>
