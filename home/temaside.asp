...
rsTema.Source = "SELECT id,header,subheader  FROM eitema_maindata  WHERE chosen=1"
rsTema.CursorType = 0
...
<tr> 
<td bgcolor="#FAFAF4"><img src="/shared/graphics/layout/header_arrows.gif" width="22" height="22"></td>
<td width="98%" class="sidebarHeader"> &nbsp;&nbsp;TEMA-LINKS</td>
</tr>
<tr> 
<td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
...
<tr> 
<td width="90%"> 
<!--#include virtual="/log/ei/home/inc_temalinks.txt"-->
</td>
</tr>
<tr> 
<td><img src="/shared/graphics/spacer.gif" width="3" height="8"></td>
...
<p><%=replace(rsArtikel.Fields.Item("tekst").Value,chr(13),"<br>")%> 
...
<!--#include virtual="log/ei/tema/inc_annoncer.asp"-->
</td>
</tr>
</table>
</td>
