...
rsPageData.Source = "SELECT *  FROM eiide_maindata  ORDER BY createdate desc"
...
| <a href="/home/advertising.asp">For annonc&oslash;rer</a> | <a href="http://insider.eco-info.dk/home/index.asp" target="_blank">Kom 
...
<td width="98%" class="sidebarHeader" bgcolor="#FAFAF4">&nbsp;&nbsp;JULEIDEER</td>
</tr>
<tr> 
...
<tr> 
<td> 
<p class="sidebarHeader">Her er plads til det hele<br>
Den gr&oslash;nne juleide<br>
Din mening om en gr&oslash;n jul<br>
Gr&oslash;nne julevitser<br>
Gr&oslash;nhakkere m.m.<br>
</p>
</td>
</tr>
</table>
...
<tr> 
<td> 
<p align="center">dit navn <br>
<input type="text" name="name" class="formInputobject">
<br>
din emailadresse<br>
<input type="text" name="email" class="formInputobject">
<br>
indl&aelig;ggets overskrift<br>
<input type="text" name="title" class="formInputobject">
<br>
dit indl&aelig;g<br>
<textarea name="shortdescr" class="formTextobject"></textarea>
<br>
<br>
<input type="submit" name="Submit" value="Send Ind" class="formSubmitbutton" onClick="MM_validateForm('name','','R','title','','R','shortdescr','','R');return document.MM_returnValue">
</p>
<p align="center">&nbsp;</p>
</td>
</tr>
...
<script language="javascript">
//document.forms[0].MM_insert.value="false";
</script>
<!-- #EndEditable --></td>
...
<tr> 
<td align="left"> <a href="javascript:history.go(-1)">tilbage</a> </td>
</tr>
<tr> 
<td> 
<p><span class="contentHeader1">Juleideer</span><br>
</p>
</td>
</tr>
<tr> 
...
<div align="right"> 
<% If MM_offset <> 0 Then %>
<A HREF="<%=MM_movePrev%>">forrige</A> 
<% End If ' end MM_offset <> 0 %>
- 
<% If Not MM_atTotal Then %>
<A HREF="<%=MM_moveNext%>">n&aelig;ste</A> 
...
%>
<span class="listheader"><%=(rsPageData.Fields.Item("title").Value)%></span><br>
<i></i><%=(rsPageData.Fields.Item("shortdescr").Value)%><br>
<span class="small">indsendt af <%=(rsPageData.Fields.Item("name").Value)%>, 
<%if(rsPageData.Fields.Item("email").Value)<>"" then %>
<a href="mailto:<%=(rsPageData.Fields.Item("email").Value)%>"><%=(rsPageData.Fields.Item("email").Value)%></a>, 
<%end if %>
<%=DateValue(rsPageData.Fields.Item("createdate").Value)%></span><br>
...
<tr> 
<td><img src="/shared/graphics/layout/header_arrows.gif" width="22" height="22"></td>
<td width="98%" class="sidebarHeader" bgcolor="#FAFAF4">&nbsp;&nbsp;IDEEN</td>
</tr>
<tr> 
<td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
...
<p>&nbsp;</p>
<p>Julen er en sk&oslash;n tid og ih, hvor vi forbruger.</p>
<p>Fabrikanter og butikker kan vel n&aelig;ppe leve uden. Men milj&oslash;et kunne 
vel godt.</p>
<p>S&aring; er der lige b&oslash;rnene.<br>
Hvordan tilfredstiller vi dem uden at d&aelig;nge dem til med plastleget&oslash;j?</p>
<p>Har du ideer til hvordan vi kan holde en b&aelig;redygtig jul, og stadig hygge 
os?</p>
<p>Skriv ind.</p>
</td>
</tr>
...
<tr> 
<td><img src="/shared/graphics/layout/header_arrows.gif" width="22" height="22"></td>
<td width="98%" class="sidebarHeader" bgcolor="#FAFAF4">&nbsp;&nbsp;VIND</td>
</tr>
<tr> 
<td colspan="2" height="1" background="/shared/graphics/layout/dots_horz.gif"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
...
<tr> 
<td class="sidebarHeader"> 
<p>Skriv din email i dit indl&aelig;g og du deltager i konkurrencen.<br>
Tr&aelig;kningen sker 20. december</p>
<p align="center"><a href="/dgs/detail.asp?id=17746"><img src="/ide/oerbaek_bryg_ide.jpg" width="160" height="260" border="0"></a></p>
</td>
</tr>
<tr> 
<td><img src="/shared/graphics/spacer.gif" width="3" height="8"></td>
