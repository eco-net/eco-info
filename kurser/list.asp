...
rsPageData.Source = "SELECT m.id,m.title,m.subtitle,m.shortdescription,m.startdate,m.enddate,m.organizers  FROM eicourse_maindata m  WHERE 0=0 ORDER BY m.startdate"
rsPageData.Source = replace(rsPageData.Source ,"eicourse_maindata m", theFrom)
...
<title>&Oslash;ko-info - Kurser om &oslash;kologi, natur, milj&oslash; og b&aelig;redygtighed</title>
<!-- #EndEditable --> 
...
<td class="contentHeader1" colspan="2" width="98%">Fandt <%=rsPageData_total%> kurser og uddannelser</td>
...
response.write "<tr><td><span class=""contentheader2""><a href=""" & replace(detaillink,"##",CStr(MM_offset+Repeat1__index)) & """  title=""Viser alle oplysninger om dette kursus"">"
...
<td class="contentHeader1" height="22">Fandt ingen kurser og uddannelser</td>
<td width="8"><br>
</td>
</tr>
<tr> 
...
<br>
<br>
Der er ingen kurser og uddanelser i Kursuskalenderen der matcher din søgning.<br>
Det skyldes sansynligvis, at du har lavet en meget pr&aelig;cis s&oslash;gning. 
Pr&oslash;v evt. med<br>
færre ord, eksempel 'Urter i hjemmeapoteket', s&oslash;g efter urter.</td>
<td><br>
</td>
</tr>
</table>
...
<!--#include virtual="/log/ei/kurser/inc_annoncer.asp"-->
</td>
</tr>
</table>
