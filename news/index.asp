...
theDate=DateAdd("d",-30,theDate)

set rsPageData = Server.CreateObject("ADODB.Recordset")
rsPageData.ActiveConnection = MM_ecoinfo_STRING
rsPageData.Source = "SELECT *  FROM bu_Artikel a LEFT JOIN bu_Artikel_site s ON a.Artikel_ID=s.artikel_id  WHERE s.econetsite<>1 AND a.create_date>="&FormatDateDB(theDate)&" ORDER BY create_date DESC"
...
rsPageData_numRows = 0
	...
	searchDescr="Nyheder oprettet indenfor de seneste <b>14 dage</b>"
...
rsTema.Source = "SELECT name  FROM eitema_maindata  WHERE chosen=1"
rsTema.CursorType = 0
...
<tr> 
<td><span class="listheader"><a href="detail.asp?id=<%=(rsPageData.Fields.Item("Artikel_ID").Value)%>"><%=toString(rsPageData.Fields.Item("Header").Value)%></a><br>
</span> 
<%if Len(rsPageData.Fields.Item("ShortDescription").Value)>0 then %>
<%=toString(rsPageData.Fields.Item("ShortDescription").Value)%> 
<%end if %>
</td>
...
<tr> 
<td>Har du kendskab til en nyhed, s&aring; <a href="mailto:eco-net@eco-net.dk?subject=Forslag%20til%20nyhed">fort&aelig;l 
os om det.</a><br>
<br>
Se ogs&aring; <a href="http://insider.eco-info.dk">&Oslash;ko-info Insider</a> 
om dine muligheder for at bruge Nyhederne på dit eget site. </td>
</tr>
<tr> 
<td><img src="/shared/graphics/spacer.gif" width="3" height="8"></td>
</tr>
