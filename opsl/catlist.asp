...
<table width="388" border="0" cellspacing="0" cellpadding="16" background="/opsl/graphics/sub_index_header_opsl_bkgrd.gif" name="subIndexHeader">
<tr> 
<td valign="top"> 
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="/shared/graphics/spacer.gif">
<tr> 
<td colspan="2" class="contentHeader1">Kategorier p&aring; Opslagstavlen</td>
</tr>
<tr> 
...
<tr> 
<td width="66%" valign="top"> Nedenfor ser du en oversigt over kategorierne p&aring; 
Opslagstavlen.<br>
V&aelig;lg en hoved- eller underkategori for at f&aring; vist opslag i den p&aring;g&aelig;ldende 
kategori. </td>
<td width="34%">&nbsp;</td>
</tr>
</table>
...
<tr> 
<td valign="top"> 
<!--#include virtual="/log/ei/opsl/inc_catlist.txt"-->
</td>
</tr>
</table>
<!-- #EndEditable --> </td>
