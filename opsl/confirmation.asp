...
<%IF request("done")=1 THEN
	response.write "Opslaget er oprettet."
	IF LEN(request("userpw"))>0 THEN
		response.write "<br><br>Du er blevet oprettet som bruger.<br>" &_
		"Brugernavn: " & request.cookies("eiusername") & "<br>" &_
		"Adgangskode: " & request("userpw")
	END IF
ELSEIF request("done")=4 THEN
	response.write "Opslaget er slettet."
END IF
response.write "<br><br><div align=""center""><input type=""button"" value=""OK"" class=""formbutton"" onClick=""this.form.action='index.asp';this.form.submit();""></div>"
