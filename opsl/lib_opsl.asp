...
SUB DoCreate(thefilename)
	...
	theSQL="INSERT INTO eiopsl_maindata(" &_
		"title,indsender,telefon,email,exitdato,cat_id,postnr,kort_beskrivelse,lang_beskrivelse,billede_filnavn,billede_width,billede_height,userid,siteid" &_
		") VALUES (" &_
	...
	ELSE
		...
		response.cookies("eiuserid")=userID
