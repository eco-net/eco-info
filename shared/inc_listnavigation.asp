...
IF NOT MM_atTotal THEN
	naviHtml=naviHtml & "<a href=""" & replace(urlStr,"##",Cstr(MM_offset + MM_size)) & """ title=""Til næste side i oversigten"">N&aelig;ste side<img src=""/shared/graphics/layout/arrows_fwd.gif"" width=""10"" height=""7"" border=""0""></a><br>Side " 
ELSE
